 ...
 */
public class DistanceLoader extends AsyncTaskLoader<Distance> {
    ...
    /**
     * Constructs a new {@link DistanceLoader}.
     *
     ...
     */
    @Override
    public Distance loadInBackground() {
        ...
        Distance distance = QueryUtils.fetchPlaceDistanceData(mUrl);
        return distance;
    }
}
